...
<script type="text/javascript">
	function myclose() {
		window.location="${pageContext.request.contextPath}/prod/cancelupdate.action";
	}
</script>
			<div id="table">
				<form action="${pageContext.request.contextPath}/prod/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<input type="hidden" name="pDate" value="${prod.pDate}">
					<table>
						<tr>
						...
						<tr>
							...
							<td>
								<select name="typeId">
									<c:forEach items="${applicationScope.ptlist}" var="type">
